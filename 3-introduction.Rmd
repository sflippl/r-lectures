...
1. Why do you think that the following code does not work?
...
3. Look up possible arguments to `geom_point` by calling `?geom_point` and try to make the points in our scatterplot red.
